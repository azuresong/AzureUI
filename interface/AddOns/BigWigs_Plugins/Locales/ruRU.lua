...
L.customBarSlashPrint = "Данная функция переименована. Используйте /raidbar чтобы отправить полосу в рейд или /localbar для полосы, видимой только вами."
...
L.printKillOption = "Время побед"
L.printWipeOption = "Время поражений"
