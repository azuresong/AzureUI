...
L["Glow only at procs"] = true
L["Only show glow during procs, otherwise also show it after cooldown ending."] = true
L["enchant(ppm)"] = true
L["Scan and show an average cd based on haste * real-ppm of player's enchant with a real-ppm mechanism. "] = true
