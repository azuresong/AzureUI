...
[1159]={7.5,8.5,8,{12}},
[1160]={8.5,8,7.5,{8}},
[1161]={8,8.5,7.5,{4,8,10,14,18,20}},
...
[1168]={8,8,8,{22}},
[1174]={7.5,8.5,8,{12}},
[1175]={8,8,8,{3,12,13,22}},
[1176]={8,8,8,{3,13}},
[1177]={9,8,7,{6,7,9,10}},
[1178]={8,8,8,{4}},
[1179]={8,8.5,7.5,{3}},
[1180]={7,8.5,8.5,{4,5,8,10}},
[1181]={7.5,8,8.5,{6,9,16,19}},
[1182]={8.5,7.5,8,{3,12,13,22}},
[1185]={8,8,8,{9,19}},
[1196]={8,8,8,{9,19}},
[1197]={8,8,8,{7,17}},
[1198]={8,8,8,{8,18}},
...
[1208]={7.5,8,8.5,{21}},
[1209]={7.5,8,8.5,{13}},
[1211]={7,8.5,8.5,{14,15,18,20}},
[1212]={7,8.5,8.5,{4,5,8,10}},
[1213]={7,8.5,8.5,{14,15,18,20}},
--------训练师：
[872]={8,8,8,{3}},
[873]={8,8,8,{3}},
...
[1129]={25.5,11.5,7.25,{7}},
[1187]={25.5,11.5,7.25,{4}},
[1188]={25.5,11.5,7.25,{3}},
[1189]={25.5,11.5,7.25,{9}},
[1190]={25.5,11.5,7.25,{11}},
[1191]={25.5,11.5,7.25,{6}},
[1192]={25.5,11.5,7.25,{10}},
[1193]={25.5,11.5,7.25,{12}},
[1194]={25.5,11.5,7.25,{8}},
[1195]={25.5,11.5,7.25,{5}},


[758]={7.5,8.5,8,{18}}, -----红色小神龙，这玩意谁有？
[1127]={7.5,8.5,8,{8}}, ---另一只幽灵虎（老版卡牌）
...
HPetDate.SearchNoPet=function()
	...
	local MAX=0
--~ 	for i = 1300 , 1 ,-1 do
--~ 		if (HPetDate[i]) and not tableP(HPetDate[i],HPetDate_New[i]) then
--~ 			local str=select(1,C_PetJournal.GetPetInfoBySpeciesID(i))
--~ 			print(str,i)
--~ 			MAX=MAX+1
--~ 		end
--~ 	end
--~ 	for i = 1, 1300 do
--~ 		if HPetDate_New[i] and not HPetDate[i] then
--~ 			local str=select(1,C_PetJournal.GetPetInfoBySpeciesID(i))
--~ 			print(str,i)
--~ 			MAX=MAX+1
--~ 		end
...
HPetDate.GetBreedValue=function(petstate,speciesID,ifprint)
	...
	if type(petstate)=="table" then
		level,health,power,speed,rarity,isflying = petstate.level, petstate.health, petstate.power, petstate.speed, petstate.rarity, petstate.isflying
	else
		isflying = false
		speciesID, _, level = C_PetJournal.GetPetInfoByPetID(petstate)
		_, health, power, speed, rarity = C_PetJournal.GetPetStats(petstate)
	...
	if petstate and  speciesID and HPetDate[speciesID] then
		...
		local GetBreedIDbySystem = function()
			for i = 3 , 12 do
				...
				if math.abs(format("%.1f",(bhealth+thealth)*5*level*breed+100) - format("%.0f",health or 0)) <= 0.5*5 then
					if math.abs(format("%.1f",(bpower+tpower)*level*breed) - format("%.0f",power or 0)) <= 0.5 then
						if math.abs(format("%.1f",(bspeed+tspeed)*level*breed) - format("%.0f",speed or 0)) <= 0.5*(isflying and 1.5 or 1) then
							breedID=i
							return true
						end
					end
...
--~ print(self:GetName(),speciesID,breedID,rarityvalue)
	...
	if not speciesID or (not HPetAllInfoFrame:IsShown() and self ~= HPetAllInfoFrame) then return end
