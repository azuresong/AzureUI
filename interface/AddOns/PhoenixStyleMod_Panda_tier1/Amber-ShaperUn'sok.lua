...
if (arg2=="SPELL_DISPEL" or arg2=="SPELL_STOLEN") and arg9==122784 and arg13 then
  pscaststartinfo(0,arg13..": "..psaddcolortxt(1,name1)..name1..psaddcolortxt(2,name1).." "..arg2.." > "..arg13, -1, "id1", 7, "|s4id"..arg9.."|id - "..psdispellinfo,psbossnames[2][2][5],2)
  
  if psraidoptionson[2][2][5][11]==1 and pswasonbossp25==1 then
    pszapuskanonsa(psraidchats3[psraidoptionschat[2][2][5][11]], "{rt8} "..name1.." > "..name2.." |s4id"..arg12.."|id - |s4id"..arg12.."|id")
  end
