...
if arg2=="SPELL_AURA_REMOVED" and spellid==136442 then
      --изменение текста
        if pssidamageinf_title2[pssavedplayerpos] and pssidamageinf_title2[pssavedplayerpos][1] and #pssidamageinf_title2[pssavedplayerpos][1]>0 and pscduhontabldamage1 then
          for ii=1,#pscduhontabldamage1[1] do
