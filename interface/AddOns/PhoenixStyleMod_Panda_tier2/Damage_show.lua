...
function pscduhadddamage(tip,name1,guid2,arg12,arg13,spellid,targetname) --tip nr of trackers +1100, 1101, 1102, 1103, 1104 óâåëè÷èâàòü íîìåð +tip первые 3 трекера заняты
