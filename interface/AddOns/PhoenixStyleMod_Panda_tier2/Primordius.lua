...
--диспел хороших
if (arg2=="SPELL_DISPEL" or arg2=="SPELL_STOLEN") and (spellid==136184 or spellid==136186 or spellid==136182 or spellid==136180 or spellid==140546) then
  if pswasonbossp58==nil then
    pswasonbossp58=1
  end
  psunitisplayer(guid2,name2)
  if psunitplayertrue then
    pscaststartinfo(0,spellname..": "..psaddcolortxt(1,name2)..name2..psaddcolortxt(2,name2).." < "..psaddcolortxt(1,name1)..name1..psaddcolortxt(2,name1).." ("..arg13..")", -1, "id1", 4, pszzpandattaddopttxt14.." - "..psdispellinfo,psbossnames[2][5][8],2)
  end
end
