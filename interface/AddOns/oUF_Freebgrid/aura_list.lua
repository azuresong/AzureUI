...
ns.auras = {
    ...
    instances = {
        ...
        --},
		[930] = {
			--Jin'rokh tanke debuff
			[GetSpellInfo(138349)] = 7,
			--hydra burning flesh
			[GetSpellInfo(137731)] = 7,
			--Tortos Crystal Shell: Full Capacity
			[GetSpellInfo(140701)] = 72,
			--Tortos Crystal Shell
			[GetSpellInfo(137633)] = 71,
			--Durumu bleed
			[GetSpellInfo(133768)] = 7,
			--Twin Consorts beast of nightmares
			[GetSpellInfo(137341)] = 7,
		},
		[886] = { --[[ Terrace of Endless Spring ]]--

            --Protector Kaolan	
			[GetSpellInfo(111850)] = 75, --Lightning Prison: Targeted
			[GetSpellInfo(117436)] = 74, --Lightning Prison: Stunned
			[GetSpellInfo(117519)] = 73, --Touch of Sha
			[GetSpellInfo(118191)] = 72, --Corrupted Essence
		...
		[896] = { --[[ Mogu'shan Vaults ]]--
			...
			--Subetai the Swift
			[GetSpellInfo(118048)] = 72, --Pillaged
			[GetSpellInfo(118047)] = 71, --Pillage: Target
			[GetSpellInfo(118135)] = 73, --Pinned Down
